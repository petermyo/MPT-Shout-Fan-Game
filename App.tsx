      ...
      <nav className="z-40 bg-white/95 backdrop-blur-md shadow-lg py-3 px-6 flex items-center justify-between border-b-2 border-mpt-yellow shrink-0">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <Mic className="text-blue-900" size={20} />
            ...
            <div className="bg-white/10 rounded-3xl p-6 border border-white/10 backdrop-blur-xl shadow-2xl flex-shrink-0">
                ...
                <div className="grid grid-cols-1 gap-4">
                    <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex justify-between items-center">
                        <div className="text-xs text-mpt-yellow/70 uppercase font-black tracking-widest">Total Shouts</div>
                        <div className="text-3xl font-black tabular-nums">{history.length}</div>
                    </div>
                    <div className="bg-white/5 p-4 rounded-2xl border border-white/5 flex justify-between items-center">
                        <div className="text-xs text-mpt-yellow/70 uppercase font-black tracking-widest">Max Power Wins</div>
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 text-gray-800 shadow-2xl border-2 border-white/50 flex-1 overflow-auto custom-scrollbar">
                ...
                <ul className="space-y-5">
                    <li className="flex gap-4 items-start">
                        ...
                        <p className="text-sm font-bold text-gray-600 leading-snug">Click <span className="text-blue-900">START CHALLENGE</span> and allow Mic access.</p>
                    </li>
                    <li className="flex gap-4 items-start">
                        ...
                        <p className="text-sm font-bold text-gray-600 leading-snug">Shout as loud as you can! Higher volume = better prize tiers.</p>
                    </li>
                    <li className="flex gap-4 items-start">
                ...
                <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                   <p className="text-[10px] font-black tracking-widest uppercase text-gray-400">© MPT Shout Fan Game 2024</p>
                </div>
            </div>
        </div>
      </main>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-sm rounded-[3rem] p-10 text-center shadow-2xl border-[8px] border-mpt-yellow animate-in zoom-in duration-300">
                ...
                <div className="mt-10 mb-6">
                    <h2 className="text-blue-900 font-black text-5xl tracking-tighter uppercase mb-3 leading-none">VICTORY!</h2>
                    ...
                    <p className="text-gray-500 font-black text-xs uppercase tracking-[0.3em] mb-4">You claimed the prize</p>
